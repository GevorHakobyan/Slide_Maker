#############################################################################
# Makefile for building: SlideMaker
# Generated by qmake (3.1) (Qt 5.15.13)
# Project:  power.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile power.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = SlideMaker1.0.0
DISTDIR = /home/geveorg/Desktop/Slide_Maker/.tmp/SlideMaker1.0.0
SUBTARGETS    =  \
		release \
		debug
...
Makefile: power.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
